...
public class Recaptcha2Page extends base {
    ...
    public void setResponseForRecaptchaWithSelenium() throws InterruptedException, IOException {
        driver.get(pageUrl);
        Thread.sleep(2000);
        new WebDriverWait(driver, 10).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.xpath("//iframe[@name='a-m436uflc3otv']")));
        try {
        ...
        try {
            ...
            List<WebElement> newIframeList = driver.findElements(By.xpath("//iframe[@name='a-m436uflc3otv']"));
